...
// import HeroPageExperimental from './experimental/heropageexperimental.tsx'
// change the code from <HeroPage /> to <HeroPageExperimental /> in the page.tsx
...
<div style={{ display: 'flex', flexDirection: 'column', minHeight: '100vh', }}> 
    <section className="container-fluid" style={{ minHeight: '800px', position: 'relative' }}> 
  <Image 
  ...
  <RegisterModal
      ...
      {/* Content specific to the first page goes here */}
        <h2 className="fw-bold text-start p-2 text-center">Welcome to CCS Manuscript Repository, the ultimate resource hub for computer science and information 
        technology thesis and capstone projects. </h2> <h4 className="text-end text-center">Dive into a wealth of knowledge curated from the brightest 
        minds in the field. Explore groundbreaking research, innovative solutions, and transformative ideas that shape the future of technology. Whether you're a student seeking inspiration or a researcher on the quest for cutting-edge insights, our platform is your gateway to the forefront of computational advancements.</h4>
...
export default HeroPageExperimental;